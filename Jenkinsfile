...
pipeline {
	...
	environment {
        ...
        final dockerPort = "8082"
        final url = env.JENKINS_URL.replaceAll("8080", dockerPort);
        final imageName = "env"
        final dockerName = "api"
        final apiRep = "git@github.com:username/BookStore.git"
        final testCaseRep = "git@github.com:username/TestCase.git"
